    ...
    useEffect(() => {
        ...
        fetch('/api/reviews', { signal: controller.signal })
            ...
            .then(data => {
                ...
                if (data?.rating) {
                    setVenue(prev => ({ ...prev, rating: data.rating, reviewCount: data.user_ratings_total }));
                }
            })
            .catch(err => {
                ...
                <main className={styles.mainContent}>
                    <section className={styles.sectionWrapper}>
                        <div id="services" style={{ scrollMarginTop: '140px' }}>
                            <ServiceList services={services} onServiceSelect={handleServiceSelect} isSearching={false} isLoading={servicesLoading} buttonText="Book" selectedIds={selectedServices.map(s => s.id)} />
                        </div>
                    </section>
                    ...
                    <section className={styles.sectionWrapper}>
                        <div id="reviews" style={{ scrollMarginTop: '140px' }}>
                            <ReviewsSection reviews={reviews} rating={venue.rating} reviewCount={venue.reviewCount} />
                        </div>
                    </section>
                </main>
